  ...
  <div class="sex">
    ...
    <section>
      <div class="pic">
        ...
        <div class="right" @click='touch2'>
          <div class="nan">
            <img src="../../public/img/nan1.png" alt="" class="nan1" ref="nan1">
            <img src="../../public/img/nan2.png" alt="" class="nan2" ref="nan2">
          </div>
          <p>男士</p>
        </div>
    ...
    <button class="sex_done" ref="anniu">完成</button>
  </div>
</template>
...
export default {
  ...
  methods:{
    touch1(){
      ...
      this.$refs.anniu.style.background='linear-gradient(to right, #fe4c68, #ff8a5f)'
    },
    touch2(){
